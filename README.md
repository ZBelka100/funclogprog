...
[Расширение] - файл `mmaextention-1.1.0.vsix`. 
...
### Другие примеры
Вы можете найти другие примеры написанные на языке `S_S` [в папке примеров](https://github.com/MAILabs-Edu-2024/fp-compiler-lab-starlight-sky/tree/main/docs) а также их можно запустить с помощью интерпретатора.

## Стандартная библиотека

Для упрощения работы с языком, написана стандартная [библиотека](https://github.com/MAILabs-Edu-2024/fp-compiler-lab-starlight-sky/blob/main/Main/standart_library.mma).
...
Эссе на тему "Приёмы функционального программирования, как мы их использовали при выполнении курсовой, и как будем использовать в дальнейшей жизни" расположено [тут](https://github.com/MAILabs-Edu-2024/fp-compiler-lab-starlight-sky/blob/main/essay.pdf).
